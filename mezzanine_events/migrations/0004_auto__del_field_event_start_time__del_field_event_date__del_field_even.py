...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'mezzanine_events_event', 'start_time')

        # Deleting field 'Event.date'
        db.delete_column(u'mezzanine_events_event', 'date')

        # Deleting field 'Event.end_time'
        db.delete_column(u'mezzanine_events_event', 'end_time')


    def backwards(self, orm):
        # Adding field 'Event.start_time'
        db.add_column(u'mezzanine_events_event', 'start_time',
                      self.gf('django.db.models.fields.TimeField')(default=datetime.datetime(2014, 1, 24, 0, 0)),
                      keep_default=False)

        # Adding field 'Event.date'
        db.add_column(u'mezzanine_events_event', 'date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 1, 24, 0, 0)),
                      keep_default=False)

        # Adding field 'Event.end_time'
        db.add_column(u'mezzanine_events_event', 'end_time',
                      self.gf('django.db.models.fields.TimeField')(default=datetime.datetime(2014, 1, 24, 23, 59)),
                      keep_default=False)
