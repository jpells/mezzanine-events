...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'mezzanine_events_event', 'event_location_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mezzanine_events.EventLocation'], null=True))

    def backwards(self, orm):

        # Changing field 'Event.event_location'
        db.alter_column(u'mezzanine_events_event', 'event_location_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['mezzanine_events.EventLocation']))
    ...
    models = {
        u'mezzanine_events.event': {
            ...
            'event_location': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['mezzanine_events.EventLocation']", 'null': 'True', 'blank': 'True'}),
            'facebook_event': ('django.db.models.fields.BigIntegerField', [], {'null': 'True', 'blank': 'True'}),
