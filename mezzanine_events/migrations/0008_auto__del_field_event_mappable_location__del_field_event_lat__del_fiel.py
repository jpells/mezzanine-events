...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Event.mappable_location'
        db.delete_column(u'mezzanine_events_event', 'mappable_location')

        # Deleting field 'Event.lat'
        db.delete_column(u'mezzanine_events_event', 'lat')

        # Deleting field 'Event.lon'
        db.delete_column(u'mezzanine_events_event', 'lon')

        # Deleting field 'Event.location'
        db.delete_column(u'mezzanine_events_event', 'location')


    def backwards(self, orm):
        # Adding field 'Event.mappable_location'
        db.add_column(u'mezzanine_events_event', 'mappable_location',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True),
                      keep_default=False)

        # Adding field 'Event.lat'
        db.add_column(u'mezzanine_events_event', 'lat',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=7, blank=True),
                      keep_default=False)

        # Adding field 'Event.lon'
        db.add_column(u'mezzanine_events_event', 'lon',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=7, blank=True),
                      keep_default=False)

        # Adding field 'Event.location'
        db.add_column(u'mezzanine_events_event', 'location',
                      self.gf('django.db.models.fields.TextField')(default='location'),
                      keep_default=False)
