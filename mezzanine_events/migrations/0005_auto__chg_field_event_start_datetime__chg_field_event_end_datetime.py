...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Event.start_datetime'
        db.alter_column(u'mezzanine_events_event', 'start_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 1, 24, 0, 0)))

        # Changing field 'Event.end_datetime'
        db.alter_column(u'mezzanine_events_event', 'end_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 1, 24, 23, 59)))

    def backwards(self, orm):

        # Changing field 'Event.start_datetime'
        db.alter_column(u'mezzanine_events_event', 'start_datetime', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Event.end_datetime'
        db.alter_column(u'mezzanine_events_event', 'end_datetime', self.gf('django.db.models.fields.DateTimeField')(null=True))
