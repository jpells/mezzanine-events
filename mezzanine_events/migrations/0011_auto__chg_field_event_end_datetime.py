...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Event.end_datetime'
        db.alter_column(u'mezzanine_events_event', 'end_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 4, 4, 0, 0)))
    ...
    models = {
        u'mezzanine_events.event': {
            ...
            'event_location': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['mezzanine_events.EventLocation']"}),
