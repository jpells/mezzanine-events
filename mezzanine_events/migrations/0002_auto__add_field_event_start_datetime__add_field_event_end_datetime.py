...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'mezzanine_events_event', 'start_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'Event.end_datetime'
        db.add_column(u'mezzanine_events_event', 'end_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'mezzanine_events_event', 'start_datetime')

        # Deleting field 'Event.end_datetime'
        db.delete_column(u'mezzanine_events_event', 'end_datetime')
